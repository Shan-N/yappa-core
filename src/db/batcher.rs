...
//         let raw_sql = r#"
//             INSERT INTO messages (message_id, tenant_id, conversation_id, sender_id, content, created_at)
//             SELECT * FROM UNNEST($1::uuid[], $2::text[], $3::uuid[], $4::text[], $5::text[], $6::timestamptz[])
//         "#;
